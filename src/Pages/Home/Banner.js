        ...
        <section className='mb-10 bg-accent bg-opacity-10 py-10 rounded-xl'>
            <div className='flex justify-around items-center flex-col md:flex-row-reverse'>
                ...
                <div className='pl-0 md:pl-40 w-full md:w-1/2 '>
                    <h4 className='text-2xl text-nutral font-semibold my-2 uppercase '>We have 15000+ jobs</h4>
                    ...
                    <p className='text-nutral my-2'>Find jobs, create trackable resumes and enrich your applications.Carefully crafted after analyzing the needs of different industries.</p>
