            ...
            <div className='flex justify-around items-center flex-col md:flex-row-reverse'>
                ...
                <div className='pl-0 md:pl-40 w-full md:w-1/2 '>
                    ...
                    <div className='flex flex-col md:flex-row rounded-lg'>
                        ...
                        <Link to={`job/search/title=${search}`} className='flex btn items-center justify-center btn-primary px-2'>Find Job<FiSearch className='text-xl mx-2'></FiSearch></Link>
                    </div>
                </div>
            </div>
        </section>
