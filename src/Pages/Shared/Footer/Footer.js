            ...
            <footer class="footer p-10 bg-base-300 text-base-content">
                <div className='pl-10'>
                    ...
                    <div class="grid grid-flow-col gap-4">
                        ...
                        <a className='hover:text-accent'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
                    </div>
                </div>
                <div>
                    <span class="footer-title">Company</span>
                    <Link to='/about' class=" hover:scale-105 duration-300">About us</Link>
                    <Link to='/contact' class=" hover:scale-105 duration-300">Contact us</Link>
                    <Link to='/services' class=" hover:scale-105 duration-300">Services</Link>
                    <Link to='/blog' class=" hover:scale-105 duration-300">Blog</Link>
                </div>
                <div>
